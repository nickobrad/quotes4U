...
export class QuotesComponent implements OnInit {
  ...
  quotes: QuotesTemplate[] = [
    ...
    new QuotesTemplate(3, 'Kanye West', 'Do not let me get in my zone, The stars is in the building, They hands is to the ceiling, I know I am bout to kill it', new Date(2019,1,15), 24, 8),
